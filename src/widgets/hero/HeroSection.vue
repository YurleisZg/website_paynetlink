...
<template>
    <section data-testid="hero-section" class="scroll-reveal bg-white px-6 py-24 md:px-20 md:py-32">
        <Container class="flex flex-col items-center gap-15 md:flex-row">
