...
useSeo(PAGE_SEO["contact-advisor"]!);
...
<template>
    <div class="flex min-h-screen w-full flex-col lg:flex-row">
        ...
        <div
            class="hidden w-full flex-col items-center justify-center bg-primary px-8 py-16 md:px-12 lg:flex lg:w-1/2 lg:px-16 xl:px-24 2xl:px-32"
        >
            <div class="flex w-full max-w-[600px] flex-col gap-8">
                <!-- Logo -->
                <router-link
                    to="/"
        ...
        <div
            class="flex w-full flex-col items-center justify-center bg-white px-6 py-12 md:px-12 lg:w-1/2 lg:px-16 xl:px-24 2xl:px-32"
        >
