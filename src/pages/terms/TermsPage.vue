...
<template>
    <div class="flex min-h-screen flex-col bg-white">
        ...
        <!-- Hero Section -->
        <section class="bg-surface py-12 sm:py-14 lg:py-16" aria-labelledby="terms-heading">
            ...
            <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-20">
                <div class="mx-auto max-w-3xl">
                    ...
                    >
                        ...
                        >
                            {{ t(`terms.page.sections.${section}.title`) }}
                        </h2>
                        <p class="font-body text-base leading-relaxed text-secondary">
                            {{ t(`terms.page.sections.${section}.content`) }}
                        </p>
                    </article>
                </div>
            </div>
